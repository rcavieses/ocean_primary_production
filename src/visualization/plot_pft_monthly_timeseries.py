...
data_file = base_dir / 'data' / 'raw' / 'pft_golfo_california_2000_2024.nc'

# Check for filter info (when running from run_all_map_scripts_filtered.py)
import json
filter_info_file = base_dir / 'data' / 'processed' / 'pft_golfo_california_FILTER_INFO.json'
if filter_info_file.exists():
    output_subdir = 'fig_filt'
else:
    output_subdir = 'timeseries'

output_dir = base_dir / 'results' / 'satellite' / 'figures' / output_subdir
