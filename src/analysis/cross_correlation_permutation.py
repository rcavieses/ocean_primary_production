...
CLIMATE_INDICES = {
    'MEI': {
        'file': 'data/raw/mei.exttimeseries.csv',
        'loader': 'mei'
    },
    'PDO': {
        'file': 'data/raw/pdo.timeseries.sstens.csv',
        'loader': 'pdo'
    },
    'NINO34': {
        'file': 'data/raw/nino34.long.anom.csv',
        'loader': 'nino'
    }
}
...
def main():
    ...
    for idx_name, idx_series in climate_indices.items():
        for var in SPECIES_VARS:
            ...
            result.to_csv(base_dir / 'results' / 'satellite' / 'tables' / 'correlations' / outname, index=False)
