...
FIGURES_BASE = BASE_DIR / 'results' / 'satellite' / 'figures'
...
# In-situ results (parametrizable via env var TAXONOMY_VERSION, default v2)
_TAXONOMY_VERSION = os.environ.get('TAXONOMY_VERSION', 'v2')
DEPTH_RESULTS      = BASE_DIR / 'results' / 'insitu' / f'edna_{_TAXONOMY_VERSION}' / 'profundidad'
TIMESERIES_RESULTS = BASE_DIR / 'results' / 'insitu' / f'edna_{_TAXONOMY_VERSION}' / 'series_tiempo'
