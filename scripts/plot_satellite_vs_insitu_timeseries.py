...
Datos:
  ...
  - In situ:   taxonomy_corrected_edna.csv (eDNA, Golfo de California)
...
OUTPUT_DIR = BASE_DIR / 'resultados_series_tiempo' / 'comparacion_satelital_insitu'
...
def load_insitu_data():
    ...
    print("  Cargando datos eDNA in situ (taxonomy_corrected_edna.csv)...")
