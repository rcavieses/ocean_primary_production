...
OUTPUT_DIR = BASE_DIR / 'resultados_analisis_profundidad'
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

SATELLITE_FILE = DATA_DIR / 'pft_monthly_statistics.nc'
TAXONOMY_FILE = DATA_DIR / 'taxonomy_corrected_edna.csv'
NINO_FILE = DATA_DIR / 'nino34.long.anom.csv'
MEI_FILE = DATA_DIR / 'mei.exttimeseries.csv'
PDO_FILE = DATA_DIR / 'pdo.timeseries.sstens.csv'
...
def main():
    ...
    print(f"\n[2/9] Series de tiempo por profundidad (por grupo)...")
